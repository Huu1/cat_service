...
export class CreateDictTables1744108703639 implements MigrationInterface {
    name = 'CreateDictTables1744108703639'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`dict_items\` DROP FOREIGN KEY \`FK_c17cfff60ef9d52cf0a61d86495\``);
        ...
        await queryRunner.query(`ALTER TABLE \`files\` ADD \`originalName\` varchar(255) NOT NULL COMMENT '文件原始名称'`);
        await queryRunner.query(`ALTER TABLE \`dict_items\` DROP COLUMN \`value\``);
        await queryRunner.query(`ALTER TABLE \`dict_items\` ADD \`value\` varchar(255) NULL COMMENT '附加数据'`);
        await queryRunner.query(`ALTER TABLE \`dict_items\` DROP COLUMN \`additionalData\``);
        await queryRunner.query(`ALTER TABLE \`dict_items\` ADD \`additionalData\` varchar(255) NULL COMMENT '附加数据'`);
        ...
        await queryRunner.query(`ALTER TABLE \`dict_items\` ADD CONSTRAINT \`FK_c17cfff60ef9d52cf0a61d86495\` FOREIGN KEY (\`dict_type_id\`) REFERENCES \`dict_types\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`dict_items\` ADD CONSTRAINT \`FK_c17cfff60ef9d52cf0a61d86495\` FOREIGN KEY (\`dict_type_id\`) REFERENCES \`mytest\`.\`dict_types\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
